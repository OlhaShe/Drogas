...
public class LoginPage extends ParentPage {
    ...
    public void openLoginPage() {
        actionsWithElements.openSite();
        actionsWithElements.click(linkToLoginPage);
    }

    public void enterLoginB2C(String loginData) {
        actionsWithElements.clickOnElement(inputEmailB2C, loginData);

    }

    public void enterPasswordForB2C (String passwordData) {
        actionsWithElements.clickOnElement(inputPasswordB2C, passwordData);
    ...
    public void enterLoginB2B(String loginData) {
        actionsWithElements.clickOnElement(inputEmailB2B, loginData);
    }


    public void enterPasswordForB2B(String passwordData) {
        actionsWithElements.clickOnElement(inputPasswordB2B, passwordData);
    }
